...
from keras_resnet.models import ResNet2D50
from keras_retinanet.models import backbone, load_model

from object_detector_retinanet.keras_retinanet import models
from object_detector_retinanet.keras_retinanet.bin.train_resnet import create_model
...
from object_detector_retinanet.keras_retinanet.utils.predict_resnet import predict
...
from object_detector_retinanet.utils import image_path, annotation_path, root_dir, replace_env_vars
...
def parse_args(args):
    ...
    parser = argparse.ArgumentParser(
        description='Evaluation script for a ResNet network.')
...
def main(args=None):
    ...
    # model = load_model(args.model, f'resnet{args.layers}')
    model = create_model(layers=args.layers, weights=args.model, num_classes=generator.num_classes())
    ...
    # Print metrics
    # evaluate the model
    # loss, precision, recall = model.evaluate_generator(generator, steps=generator.size(), verbose=1)

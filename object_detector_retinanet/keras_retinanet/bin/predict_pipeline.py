...
def parse_args(args):
    ...
    parser.add_argument('--object-detection-model', help='Path to RetinaNet object detection model.')
    parser.add_argument('--bay-detection-model', help='Path to RetinaNet bay detection model.')
